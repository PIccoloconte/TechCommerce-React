...
const Footer = () => {
  return (
    <div className="px-8 py-12 text-center bg-footer_color xl:px-40 xl:text-start">
      <div className="xl:flex xl:justify-between">
        ...
        <div className="mb-8 xl:text-start">
          ...
          <Link className="text-[#CFCFCF] block mb-2 leading-8">
            Bonus program
          </Link>
          <Link className="text-[#CFCFCF] block mb-2 leading-8">
            Gift cards
          ...
          <Link className="text-[#CFCFCF] block mb-2 leading-8">Payment</Link>
        </div>
        <div className="mb-8 xl:text-start">
